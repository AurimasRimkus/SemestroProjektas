 ...
 */
class Version20180418130710 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, profile_id INT DEFAULT NULL, cariukas VARCHAR(255) DEFAULT NULL, arrivalDate DATETIME NOT NULL, isDone TINYINT(1) NOT NULL, INDEX IDX_E52FFDEECCFA12B8 (profile_id), UNIQUE INDEX UNIQ_E52FFDEE69C68899 (cariukas), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_E52FFDEE69C68899 FOREIGN KEY (cariukas) REFERENCES cars (number_plate)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE orders DROP FOREIGN KEY FK_E52FFDEE69C68899');
