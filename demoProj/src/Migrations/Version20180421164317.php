 ...
 */
class Version20180421164317 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, profile_id INT DEFAULT NULL, car_id VARCHAR(255) DEFAULT NULL, arrivalDate DATETIME NOT NULL, isDone TINYINT(1) NOT NULL, INDEX IDX_E52FFDEECCFA12B8 (profile_id), INDEX IDX_E52FFDEEC3C6F69F (car_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
